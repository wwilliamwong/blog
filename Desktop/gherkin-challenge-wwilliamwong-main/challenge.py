...
class Visualizer:
    ...
    def __init__(self, world: World) -> None:
        ...
        pygame.font.init()
        self.world = world
        self.screen = pygame.display.set_mode((world.width + 20, world.height + 20))
    ...
    def display_world(self) -> None:
        ...
        for x in range(0, self.world.width + 10, 10):
            ...
            pygame.draw.rect(self.screen, self.BLACK, [x, 0, 10, 10])
            pygame.draw.rect(self.screen, self.BLACK, [x, self.world.height + 10 , 20, 10])
